...
import static com.bignerdranch.android.notekeeper.NoteKeeperDatabaseContract.*;
...
//            ourInstance.initializeExampleNotes();
    ...
    private static void loadNotesFromDatabase(Cursor cursor) {
        ...
        while(cursor.moveToNext()) {
            ...
            int id = Integer.parseInt(cursor.getString(idPos));

            CourseInfo course = dm.getCourse(courseId);
            NoteInfo note = new NoteInfo(course, noteTitle, noteText, id);
            dm.mNotes.add(note);
        }
